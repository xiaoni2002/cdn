try { !
    function() {
        ...
        window.___baidu_union_dup_ || (window.___baidu_union_dup_ = {});
        ...
        function() {
            var e = {
                ...
                $oojs: function() {
                    ...
                    e.proxyName && (Function.prototype[e.proxyName] = this.proxy),
                    this.setPath(e.path),
                ...
                loadDeps: function(t, e) {
                    ...
                    for (var o in i) if (i.hasOwnProperty(o) && i[o]) {
                        ...
                        if (e[s] = !0, t[o]) t[o].__deps && (n = n.concat(this.loadDeps(t[o], e)));
                        else {
                ...
                deepClone: function(t, e) {
                    ...
                    i.setTime(t.getTime());
                        ...
                        i = [];
                        for (var o = 0,
                        s = t.length; s > o; o++) i[o] = this.deepClone(t[o], n)
                ...
                define: function(t) {
                    ...
                    t.__constructor = function(t, e, i, n, o) {
                        if (this.__clones && this.__clones.length > 0) for (var s = 0,
                        r = this.__clones.length; r > s; s++) {
                    ...
                    for (var n, o = !1,
                    s = !1,
                    r = i.split("."), a = r.length, d = this.classes, l = 0; a > l; l++) n = r[l],
                    n && (d[n] = d[n] || {},
                    d = d[n]);
                    d[e] = d[e] || {};
                    var c = d;
        ...
        var s = t.oojs,
        r = (new Date).getTime();
        s.setPath('https://dup.baidustatic.com/'),
        s.define({
        ...
        s.define({
            ...
            $config: function() {
                ...
                0 !== document.location.protocol.indexOf("http") && (this.HTTP_PROTOCOL = "https:")
            }
        }),
        s.define({
            name: "lang",
        ...
        s.define({
            ...
            checkBrowser: function() {
                ...
                for (var n = ["Android", "iPad", "iPod", "iPhone", "iOS", "Linux", "Macintosh", "Windows"], o = ["iPad", "iPhone", "iOS", "iPod"], s = "", r = 0; r < n.length; r++) if (s = n[r], t.match(new RegExp(s, "i"))) {
                    o.indexOf(s) >= 0 ? this.isIOS = !0 : "Android" === s && (this.isAndroid = !0);
                    break
                }
                this.platform = s
            },
        ...
        s.define({
            ...
            $material: function() {
                ...
                this.materialFactory.slide = function(e, i) {
                    ...
                    o = [], s = e.materials, r = 0; r < s.length; r++) {
                        var a = s[r];
        ...
        s.define({
            ...
            ready: function(t, e, i) {
                ...
                function() {
                    ...
                    if (t) try {
                        if (this.readyFuncArray && this.readyFuncArray.length) for (var s = 0,
                        r = this.readyFuncArray.length; r > s; s++) {
        ...
        s.define({
            ...
            getPositionCore: function(t) {
                ...
                if (n && t.getBoundingClientRect) {
                    ...
                    e.left = Math.floor(s.left) + Math.max(o.scrollLeft, n.scrollLeft),
                    e.top = Math.floor(s.top) + Math.max(o.scrollTop, n.scrollTop),
                    e.left -= o.clientLeft,
                    e.top -= o.clientTop;
                    var r = this.getStyle(n, "borderLeftWidth"),
            ...
            getPosition: function(t) {
                if (t) {
                    ...
                    if (!n) return i;
                    for (var o = 0,
                    s = 10; n !== n.parent && o++<s && !this.dom.isInCrossDomainIframe(n) && n.frameElement;) {
            ...
            getDebugStyle: function(t) {
                ...
                i.innerHTML = e;
                var n = t.style;
                n.border = "1px solid #ff0000",
                n.boxSizing = "broder-box",
                n.position = "relative",
                t.appendChild(i)
            },
            getVisibilityInWin: function(t) {
                for (var e = t,
                i = this.dom.getWindow(e); e && e.tagName;) {
            ...
            getVisibility: function(t) {
                ...
                if (!n) return ! 1;
                for (var o = 0,
                s = 10; o++<s && this.dom.isInIframe(i) && !this.dom.isInCrossDomainIframe(i) && i.frameElement;) {
        ...
        s.define({
            ...
            queryToJson: function(t) {
                for (var e, i, n, o, s = t.substr(t.indexOf("?") + 1), r = s.split("&"), a = r.length, d = {},
                l = 0; a > l; l++) o = r[l].split("="),
                e = o[0],
                i = o[1],
                n = d[e],
        ...
        s.define({
            ...
            saveOrientation: function(t, e, i) {
                ...
                s = i.override ? {}: this.data.getInfo(o) || n,
                r = {};
            ...
            getOrientationQuery: function(t) {
                ...
                for (var s = "",
                r = i.length,
                a = 0; r > a && !(s.length + i[a].length >= t); a++) s += (a ? "&": "") + i[a];
                return s
            },
        ...
        s.define({
            ...
            },
            {
                ...
                value: function() {
                    ...
                    return e = t.location && t.location.href ? t.location.href: this.url.getTopWindowUrl(i),
        ...
        s.define({
            ...
            off: function(t, e, i) {
                ...
                if (e.indexOf("on") && (e = "on" + e), "undefined" == typeof i) delete s[e];
                else if (o = s[e]) for (n = o.length - 1; n >= 0; n--) o[n].handler === i && o.splice(n, 1);
                return t
            },
        ...
        s.define({
            ...
            start: function() {
                ...
                this.dom.g(this.fpElId) || this.event.bind(window, "load", s.proxy(this, this.createFPIframe))
            },
            ...
            loadAntiBotFile: function() {
                var t = 1e4 * Math.random();
                500 > t && setTimeout(function() {
                    var t = document.createElement("script");
                    t.type = "text/javascript",
                    t.async = !0,
                    t.src = "https://cpro.baidustatic.com/cpro/ui/ab.min.js";
        ...
        s.define({
            ...
            getPreviewUrl: function(t, e, i, n) {
                ...
                var s = n.indexOf("inlay") >= 0 ? "bd_cpro_prev": "bd_cpro_fprev",
                r = this.getPrevValue(n, o),
                a = this.parsePreviewData(r),
                d = "";
            ...
            getPrevValue: function(t, e) {
                ...
                s = t.indexOf("inlay") >= 0 || "ui" === t ? "bd_cpro_prev": "bd_cpro_fprev",
                r = "";
                try {
                    n = document.cookie
                } catch(a) {}
                return i.indexOf(s) > -1 && (r = this.url.getQueryValue(i, s)),
                !r && n && -1 !== n.indexOf(s) && (r = this.cookie.get(s)),
                r || -1 === o.indexOf(s) || (r = this.url.getQueryValue(o, s)),
                r
            },
            ...
            onPostMessageHandler: function(t) {
                if ("object" == typeof t && t.data) {
                    ...
                    if ("string" == typeof e && !(e.indexOf(this.expansionActionName) < 0)) {
                        ...
                        n.background = "#ffffff",
                        n.width = "100%",
                        n.transition = n.WebkitTransition = n.MozTransition = n.OTransition = "top 1s ease-in-out",
                        ...
                        r = Math.min(this.style.getClientWidth(), this.style.getClientHeight()),
                        a = {
                        ...
                        this.expandContainerEl.innerHTML = this.lang.template(o, a),
                        this.expandContainerEl.style.top = "0",
                        document.body.appendChild(this.expandContainerEl),
                        this.dom.bind(window, "resize", s.proxy(this, this.onResizeHandler));
        ...
        s.define({
            ...
            render: function(t) {
                ...
                n = i.container;
                this.dockTo = parseInt(n.location, 10) || this.BOTTOM,
                ...
                r = parseInt(this.adWrapEl.style.height || t.height, 10),
                a = parseInt(o.style.height, 10);
                this.hiddenHeight = -1 * (r + a),
                ...
                this.dom.bind(o, "click", s.proxy(this, this.closeBtnOnClickHandler)),
                this.dom.bind(window, "scroll", s.proxy(this, this.onScrollHandler))
            },
            validate: function(t) {
            ...
            onScrollHandler: function() {
                ...
                i = e > this.lastScrollTop ? "down": "top";
                this.totalScrollLength += e - this.lastScrollTop,
                this.lastScrollTop = e,
                "top" === i && !this.close4ever && Math.abs(this.totalScrollLength) >= t && !this.countDownTimerId ? (this.expandAd(), this.startCountDown(this.autoCloseTime, s.proxy(this, this.onTimeCountDownHandler))) : "down" === i && (this.totalScrollLength = 0)
            },
        ...
        s.define({
            ...
            expLog: function(t) {
                ...
                d = t.exps ? t.exps: "";
                e = "mip" === o ? this.config.SBD_LOG: this.config.LOG_URL,
                e += ["?type=" + o, "id=" + i, "pos=" + s, "status=" + r, "async=" + n, "mes=" + a, "exps=" + d, "from=ssp"].join("&"),
            ...
            sendLog: function(t) {
                if (t.response) {
                    ...
                    if (n) {
                        ...
                        o.onload = o.onerror = o.onabort = r,
                        o.src = n
                    }
                }
            }
        ...
        s.define({
            ...
            getPainter: function(t) {
                if (t.response) {
                    ...
                    for (var i = t.response,
                    n = ["bottomSearchBar", "inlayFix", "baiduRec", "dynamicFloat", "insideText", "mobile.inlayFix", "mobile.float"], o = 0, r = n.length; r > o; o++) {
        ...
        s.define({
            ...
            processExtendsParam: function(t) {
                ...
                if (e) {
                    ...
                    if (5 !== i.sizeType && 0 !== t.id.indexOf("u")) {
                        ...
                        0 === parseInt(s.deliv_id, 10) && (s.deliv_id = 0),
                        0 === parseInt(s.demand_id, 10) && (s.demand_id = 0);
                        var r = e["extends"] || {};
                        if (r && r.hasOwnProperty("sspw") && r.hasOwnProperty("ssph")) {
                            var a = parseInt(r.sspw || 0, 10),
                            d = parseInt(r.ssph || 0, 10),
            ...
            getParamObj: function(t) {
                ...
                if (this.browser.baiduboxapp) {
                    ...
                    r.articleTitle && (i.ti = r.articleTitle),
                    r.MP && r.MP.globalConf && (i.utdi = encodeURIComponent(window.MP.globalConf.cuid) || "", i.atdi = encodeURIComponent(window.MP.globalConf.nid) || "")
                }
            ...
            getParamString: function(t) {
                ...
                if (window && window.location && window.location.ancestorOrigins && window.location.ancestorOrigins.length) {
                    ...
                    e.push("lto=" + encodeURIComponent(o[o.length - 1])),
                    e.push("ltl=" + o.length)
                }
                return e.join("&")
            },
            getPmpRequestUrl: function(t) {
                ...
                if (c) {
                    ...
                    n.push("conwid=" + t.width),
                    n.push("conhei=" + t.height);
                    var h = c.pdb_deliv;
                    h.deliv_id && "0" !== h.deliv_id && n.push("pdbid=" + h.deliv_id),
                    c.media_protect && "0" !== c.media_protect && n.push("mpdi=" + c.media_protect);
                    var u = c.order_deliv;
                    u.deliv_id && "0" !== u.deliv_id && n.push("orderid=" + u.deliv_id),
                    u.demand_id && "0" !== u.demand_id && n.push("odid=" + u.demand_id);
                    var p = c.rtb_deliv;
                    p.deliv_id && "0" !== p.deliv_id && n.push("rtbid=" + p.deliv_id),
                    p.demand_id && "0" !== p.demand_id && n.push("rdid=" + p.demand_id);
                    var m = c.placement.complement_type;
                    if (t.isNeedCacheRequest || 4 === m || 7 === m) {
                        var f = i.qn;
                        i.dpv = f,
                        t.paramObj.dpv = f,
                        this.requestCache.add(f, t)
                    }
                    0 === t.id.indexOf("u") ? n.push("dc=3") : n.push("dc=2"),
                    r && a > 0 && (i.tt = a + "." + (d - a) + "." + (l - a) + "." + ( + new Date - a)),
        ...
        s.define({
            ...
            createSlot: function(t) {
                ...
                var i = {};
                return i.index = this.counter.slotCountIndex[e],
                i.count = 0 === e.indexOf("u") ? this.counter.slotTotalCount: 0,
                i.id = e + "_" + i.index,
                i.containerId = this.config.DUP_PREFIX + "_wrapper_" + e + "_" + i.index,
                i.slotId = t.slotId,
                i.productLine = t.productLine,
                i.errors = [],
                this.counter.slotCountIndex[e] = this.counter.slotCountIndex[e] + 1,
                this.counter.slotTotalCount = this.counter.slotTotalCount + 1,
                i.isAsync = t.isAsync,
                this.setStatus(i.id, this.config.STATUS_CREATE),
                r ? i.timestampWatcher = {
                    t1: r
                }: i.timestampWatcher = {
                    t1: 0
                },
            ...
            cloneSlot: function(t) {
                ...
                e.index = this.counter.slotCountIndex[e.slotId],
                this.counter.slotCountIndex[e.slotId] = this.counter.slotCountIndex[e.slotId] + 1,
            ...
            processSlot: function(t) {
                if (t.isPdbAd = !1, t.isNeedCacheRequest = !1, t.response) {
                    ...
                    o = parseInt(e.deliv_id, 10),
                    s = parseInt(e.demand_id, 10),
                    r = parseInt(i.deliv_id, 10),
                    a = parseInt(i.demand_id, 10),
                    d = parseInt(n.deliv_id, 10),
                    l = t.response.placement,
                    c = l && 7 === l.complement_type;
                    t.isPdbAd = !(o || s || r || a),
                    t.isNeedCacheRequest = 0 !== o && c || 0 !== r || 0 !== o && 0 !== d
                }
            },
            addSlot: function(t) {
            ...
            requestSlotInfo: function(t) {
                this.config.FIRST_ONCESEACH || (this.config.FIRST_ONCESEACH = !0, this.dom.bind(window, "message", s.proxy(this, this.onMessageHandler)));
                var e = !1;
                t.paramObj = this.param.getParamObj(t),
                t.paramObj.exps = t.exps || this.config.EXP_ID;
                var i, n;
                t.posUrl && (this.browser.antBrowser || t.proxy) ? (t.paramObj.ctxant = "1", i = this.param.getParamString(t.paramObj), n = t.posUrl + i) : (i = this.param.getParamString(t.paramObj), n = this.config.POS_URL + i),
            ...
            onMessageHandler: function(t) {
                ...
                if (e && e.tuid) {
                    ...
                    n = i && i.split("//")[1],
                    o = t.source;
                    if (e.placement && e.placement.update && e.queryid) this.updateInfo(e),
                    e.tuid.indexOf("u") > -1 && e.noadx && parseInt(e.noadx, 10) && 3 !== parseInt(e.noadx, 10) && this.unionAdIsAvailable(e);
                    else if (1 === e.type && n && o && o.parent === window) {
                        var s = this.getSlotInfoByRawId(e.tuid),
                        r = s && s.response,
            ...
            adInfoIsAvailable: function(t) {
                ...
                n = e.rtb_deliv,
                o = e.order_deliv,
                s = e.pdb_deliv.deliv_des,
                r = (s._html, e.placement.complement_type);
            ...
            processSlotInfo: function(t) {
                ...
                d = s.height,
                l = {
                    width: o.parentElement.clientWidth || 0,
                    height: o.parentElement.clientHeight || 0
                };
                if (t.styleOpenApi) {
                    var c = t.styleOpenApi;
                    if (c.scale) {
                        r = 2;
                        var h = c.scale.split(".") || {};
                        a = h[0],
                    ...
                    var u = c.cpro_w || c.rsi0 || 0,
                    p = c.cpro_h || c.rsi1 || 0; (u || p) && (r = 1, a = u || this.getCurViewportWidth(a), d = p || d)
                }
                return ("-1" === t.pcwd || t.ftpc || t.styleOpenApi.cpro_ftpc) && (r = "-1" === t.pcwd && "-1" === t.pchd ? 8 : 5),
                1 === r ? e = {
                    width: a,
                    height: d
                }: 2 === r ? (a = t.pcwd || a, d = t.pchd || d, e = this.param.translateScaleToPixelSize(a, d)) : 3 === r ? e = {
                    width: this.getCurViewportWidth(a),
                    height: d
                }: 5 === r || 6 === r ? (e.width = l.width, e.height = 6 === r ? d: Math.ceil(e.width / a * d)) : 7 === r ? e = {
                    height: l.width || 0,
                    width: a
                }: 8 === r && (e = {
                    width: l.width || 0,
        ...
        s.define({
                ...
                if (e) {
                    ...
                    if (window.postMessage && c.slotId && c.slotId.indexOf("u") > -1) {
                        ...
                        if (h && h.length) {
                            var u = h[0];
                            c.watchIframe = u,
                            c.targetOrigin = u.getAttribute("src") || "*";
                            try {
                                c.watchIframeWindow = u.contentWindow
                            } catch(p) {
                                c.watchIframeWindow = ""
                            }
                            c.viewContext.lastAdViewStatus = !1,
                            c.viewContext.lastViewStatus = !1,
                            this.dom.bind(c.watchIframe, "load",
                            function() {
                                c.watchIframeLoaded = !0,
                                c.viewContext.lastAdViewStatus = !c.viewContext.currAdViewStatus,
                                c.sendMessage()
                            })
                        }
                    }
                    this.calculateClientParam(c, e),
                    this.watchingList.push(c)
                }
            },
            ...
            buildAnalysisUrl: function(t, e) {
                if (t && e) {
                    ...
                    o.push("left=" + e.left),
                    o.push("uid=" + e.uid),
                    o.push("iw=" + n.currAdViewStatus),
                    i + o.join("&")
                }
            },
            initializeEvent: function() {
                this.windowOnLoadHandler(),
                this.dom.ready(s.proxy(this, this.windowOnLoadDelay), 2e3),
                this.browser.platform && (this.browser.platform.indexOf("Android") > -1 || this.browser.platform.indexOf("Phone") > -1 || this.browser.platform.indexOf("iPod") > -1) || this.dom.bind(this.win, "beforeunload", s.proxy(this, this.windowOnUnloadHandler))
            },
            ...
            updateViewStatus: function(t, e) {
                var i, n, o, s = e.isInView,
                r = e.isAdView,
                a = new Date;
                return i = n = o = this.intervalTimeSpan,
                t.lastViewStatus = t.currViewStatus,
                ...
                t.currViewStatus ? (this.intervalStatus === this.STATUS.LOAD && (i = parseInt(a.getTime() - t.inViewTimeStamp.getTime(), 10), 0 > i ? i = 0 : i > this.intervalTimeSpan && (i = this.intervalTimeSpan)), t.inViewTime += i, t.inViewTimeStamp = a) : s && (t.inViewTimeStamp = a),
                t.currViewStatus = s,
                t.currAdViewStatus ? (this.intervalStatus === this.STATUS.UNLOAD && (o = parseInt(a.getTime() - t.adViewTimeStamp.getTime(), 10), 0 > o ? o = 0 : o > this.intervalTimeSpan && (o = this.intervalTimeSpan)), t.adViewTime += o, t.adViewTimeStamp = a) : r && (t.adViewTimeStamp = a),
                t.currAdViewStatus = r,
            ...
            computeViewStatus: function(t) {
                ...
                if (this.winFocused) try {
                    ...
                    if (r) {
                        ...
                        c = this.style.getOuterWidth(i),
                        h = this.style.getOuterHeight(i);
                        n = l.top >= 0 && l.bottom <= d && l.left >= 0 && l.left <= a;
                        var u = l.top > 0 ? l.top: 0,
                        p = l.bottom > d ? d: l.bottom,
                        m = l.left > 0 ? l.left: 0,
                        f = l.right > a ? a: l.right,
                        g = c * h;
                        if (p > u && f > m) {
                            var y = (p - u) * (f - m);
                            o = y > .5 * g
            ...
            viewableCompute: function() {
                if (this.watchingList) for (i = 0, count = this.watchingList.length; i < count; i++) {
                    ...
                    t.viewContext = this.updateViewStatus(t.viewContext, e),
                    t.analysisUrl = this.buildAnalysisUrl(this.analysisUrl, t),
            ...
            windowOnLoadHandler: function(t) {
                ...
                this.intervalId = setInterval(s.proxy(this, this.viewOnChange), this.intervalTimeSpan)
            },
            windowOnLoadDelay: function(t) {
                var e, i, n, o, s;
                for (e = 0, i = this.watchingList.length; i > e; e++) n = this.watchingList[e],
                n && (s = n.domId, s && (o = this.win.document.getElementById(s)), o && (n.clientParam = n.clientParam || {},
            ...
            windowOnUnloadHandler: function(t) {
                try {
                    ...
                    if (t) {
                        var o, s = 200,
                        r = (new Date).getTime();
                        if (this.browser.ie) for (o = r + s; o > r;) r = (new Date).getTime();
                        else {
                            for (var i = 1e5,
                            e = 0; i > e; e++);
                            o = (new Date).getTime(),
            ...
            registerFocusEvent: function(t) {
                var t = t || this.win;
                this.winFocused = !0,
                this.browser.ie ? (this.dom.bind(t, "focusin", s.proxy(this, this.allDomOnFocusHandler)), this.dom.bind(t, "focusout", s.proxy(this, this.allDomOnBlurHandler))) : (this.dom.bind(t, "focus", s.proxy(this, this.allDomOnFocusHandler)), this.dom.bind(t, "blur", s.proxy(this, this.allDomOnBlurHandler)))
            },
        ...
        s.define({
            ...
            launch: function() {
                ...
                if (window.cpro_mobile_slot = null, s) for (var n = 0,
                o = s.length; o > n; n++) {
                    var r = s[n];
                ...
                i = this.delieveryObjArray.length; i > e; e++) {
                    ...
                    if (n.hasOwnProperty("id")) {
                        ...
                        if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync: n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
                            ...
                            productLine: "adcodex",
                            isAsync: o
                        }), n.hasOwnProperty("pos") && n.pos && (t.posUrl = this.config.HTTP_PROTOCOL + "//" + n.pos + "/s?", t.pcn = n.pos), this.additionalParam.paramCheck(t, n), t.containerId = n.container || t.containerId, t.display = n.display, t.ftpc = n.ftpc || !1, t.size = n.size || "", t.pcwd = n.pcwd || "", t.pchd = n.pchd || "", t.proxy = n.proxy || "", t.exps = n.exps || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
                            var s, r = n.size;
                            if (r && r.indexOf(":") > -1) {
                                s = r.split(":");
        ...
        s.define({
            ...
            expandAd: function(t) {
                if (!this.expandStatus[t]) {
                    ...
                    n = i.width,
                    o = i.height,
                    s = e.response.placement.container.slide,
                    r = s.slideWidth,
                    a = s.slideHeight,
                    d = 1e3 * parseInt(s.extendTime, 10),
                    l = parseInt(s.slideMode, 10),
                    c = parseInt(s.direction, 10),
                    h = e.containerId,
                    u = this.dom.g(h),
            ...
            collapseAd: function(t) {
                if (this.expandStatus[t]) {
                    ...
                    s = e.containerId,
                    r = this.dom.g(s),
                    a = r.getElementsByTagName("iframe")[0];
                    r.style.position = "",
                    r.style.width = "",
                    r.style.height = "",
                    r.style.top = "",
        ...
        s.define({
            ...
            cacheRequestCallback: function(t) {
                ...
                if ("success" !== e) {
                    ...
                    if (i) if (n.type && "rich" === n.type) {
                        var u = this.material.formatMaterial(n, i),
                        p = document.getElementById(i.containerId),
                        m = "<!DOCTYPE html><body>";
                        ...
                        this.slot.clearStatus(i, this.config.STATUS_FINISH),
                        i.isPdbAd = !0,
                        i.isNeedCacheRequest = !1,
                        v.outerHTML = this.getFrameHTML(i)
                    }
                }
            },
            ...
            renderFrame: function(t, e) {
                ...
                if (i && !this.slot.checkStatus(i, this.config.STATUS_FINISH)) {
                    ...
                    try {
                        ...
                        r.write(s),
                        r.body && (r.body.style.backgroundColor = "transparent")
                    } catch(a) {}
                }
            },
            ...
            processFrameData: function(t) {
                ...
                var d = t.width || i && i.width,
                l = t.height || i && i.height,
                c = this.creativePreview.getPreviewUrl(d, l, o, t.displayType || "inlay");
                if (c) e = c;
                else if (t.isPdbAd) {
                    var h = this.config.DUP_PREFIX + "renderFrame";
                    this.data.defineOnce(h, s.proxy(this, this.renderFrame)),
                    e = this.getFrameUrl(),
                    n = 'onload="' + h + "('" + t.id + "', this);\""
                } else if (t.isNeedCacheRequest) {
                    var u = this.config.DUP_PREFIX + "cacheRequest",
                    p = "adsbybaidu_callback";
                    this.data.defineOnce(p, s.proxy(this, this.cacheRequestCallback)),
                    this.data.defineOnce(u, s.proxy(this.requestCache, this.requestCache.cacheRequest)),
                    e = this.param.getPmpRequestUrl(t),
                    n = 'onload="' + u + "('" + t.paramObj.dpv + "', this);\""
        ...
        s.define({
            ...
            render: function(t, e) {
                try {
                    ...
                    o = n._html,
                    s = t.isNeedCacheRequest;
                    if (!e && (!o || "rich" !== o.type || s)) return ! 1;
                    var r = o.content
                } catch(a) {}
                if (!t.isAsync && !s) return document.write(r),
                ...
                h = [], u = 0; c[u]; u++) ! this.isNeededNode(c[u], "script") || c[u].type && "text/javascript" !== c[u].type.toLowerCase() || h.push(c[u]);
                h.reverse();
                for (var p = 0,
                m = h.length; m > p; p++) this.evalScript(h[p].parentNode.removeChild(h[p]), d);
                return ! 0
            }
        }),
        s.define({
            ...
            createContainerElementByInfo: function(t) {
                ...
                if (1 === t.followType) {
                    ...
                    s = this.getHorizontalStyle(t);
                    i.push(o.cssName + ":" + o.cssValue + "px;"),
                    i.push(s.cssName + ":" + s.cssValue + "px;")
                } else {
                    i.push("position: absolute;");
                    var o = this.getVerticalStyle(t),
                    s = this.getHorizontalStyle(t);
            ...
            updatePosition: function(t, e) {
                ...
                if (i) {
                    ...
                    r = o ? s: document.documentElement,
            ...
            registEvent: function(t) {
                ...
                i = this.dom.g(e);
                this.dom.bind(i, "click", s.proxy(this, this.closeBtnOnClickHandler)),
                this.dom.bind(i, "mouseover", s.proxy(this, this.closeBtnOnMouseOverHandler)),
                this.dom.bind(i, "mouseout", s.proxy(this, this.closeBtnOnMouseOutHandler))
            },
            closeBtnOnClickHandler: function() {
            ...
            render: function(t, e) {
                if (this.validate(t)) {
                    this.info = t;
                    var i = this.createCloseElement(t),
                    n = this.createBlockHtmlTemplate(t),
                    o = {
                        width: t.width,
                        height: t.height,
                    ...
                    r.innerHTML = this.lang.template(n, o),
                    this.dom.g(t.domId) || document.body.insertBefore(r, document.body.firstChild),
                    this.registEvent(t);
                    var a = t.closeTime || 0;
                    a > 0 && setTimeout(s.proxy(this, this.autoClose), 1e3 * a),
        ...
        s.define({
            ...
            render: function(t) {
                ...
                if (e) {
                    ...
                    e.innerHTML = d,
                    window.location.href.indexOf("DUP_DEBUG_FLAG") > -1 && this.style.getDebugStyle(e),
        ...
        s.define({
            ...
            processSlotInfo: function(t) {
                ...
                s = n.backgroundColor || "#000",
                r = this.slot.processSlotInfo(t);
                r.backgroundOpacity = o,
                r.backgroundColor = s;
                var a = i.location;
                return 2 !== a && 3 !== a && (a = 3),
                r.locationType = a,
                r.containerId = t.containerId,
                r.closeType = i.closeType,
                r
            },
            parseHtmlSnippet: function(t) {
            ...
            decorateContainer: function(t, e) {
                if (t) {
                    ...
                    var s = t.style;
                    s.cssText = ["box-sizing: content-box;", "position:" + i, "z-index:2147483647;", n + ":" + o, "background-color:" + e.backgroundColor, "opacity:" + e.backgroundOpacity, "text-align:center", "display:block", "font-size:0", "left:0", "width:100%", "height:" + e.height + "px"].join(";")
                }
            },
                        ...
                        if (n && (t.width = e.width, t.height = e.height, this.containerFilter(t))) {
                            ...
                            if (2 === e.sizeType) {
                                ...
                                if (r && r._html) {
                                    r = r._html;
                                    var a = r.type;
                                    "text" !== a && "image" !== a && "flash" !== a || (r.width = t.width, r.height = t.height)
                                }
                            }
                            var d = {
                                id: t.id,
                            ...
                            n.innerHTML = l,
                            window.location.href.indexOf("DUP_DEBUG_FLAG") > -1 && this.style.getDebugStyle(n);
                            var c = this.dom.g(t.containerId + "_closebtn");
                            c && this.dom.bind(c, "click", s.proxy(this, this.closeBtnOnClickHandler, t)),
        ...
        s.define({
            ...
            updateApi: function() {
                try {
                    this.data.defineOnce("BAIDU_CLB_prepareMoveSlot", s.proxy(this, this.prepareMove)),
                    this.data.defineOnce("BAIDU_DUP_addSlotStatusCallback", s.proxy(this.origentation, this.origentation.addSlotStatusCallback)),
                    this.data.defineOnce(this.config.DUP_PREFIX + "renderFrame", s.proxy(this.frame, this.frame.renderFrame)),
                    this.data.defineOnce("BAIDU_CLB_setConfig", s.proxy(this.data, this.data.putConfig)),
                    this.data.defineOnce("BAIDU_CLB_addOrientation", s.proxy(this.origentation, this.origentation.addOrientation)),
                    this.data.defineOnce("BAIDU_CLB_addOrientationOnce", s.proxy(this.origentation, this.origentation.addOrientationOnce)),
                    this.data.defineOnce("BAIDU_CLB_setOrientationOnce", s.proxy(this.origentation, this.origentation.setOrientationOnce)),
                    this.data.defineOnce("BAIDU_CLB_addSlot", s.proxy(this, this.reSet)),
                    this.data.defineOnce("BAIDU_CLB_enableAllSlots", s.proxy(this, this.reSet)),
                    this.data.defineOnce("BAIDU_CLB_SETHTMLSLOT", s.proxy(this, this.reSet))
                } catch(t) {}
            },
        ...
        s.define({
            ...
            prepareApi: function() {
                ...
                this.data.defineOnce(this.config.LOADER_DEFINE_NAME, s.proxy(this, this.callback))
            },
            callback: function(t) {
                try {
            ...
            painterLoadedCallback: function(t, e, i) {
                var n = i || s.using(t);
                n && (n.render(e), t && t.indexOf("mobile") > -1 && (this.viewWatch.regisetViewWatch(e), this.fingerPrint.loadAntiBotFile()), this.sendPVLog())
            },
            sendPVLog: function() {
